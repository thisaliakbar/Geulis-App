...
public class ServiceDetailPemeriksaan {
    ...
    public void loadData(JLabel lbIdPasien, JLabel lbIdKaryawan, JTextArea txtDesc, DefaultTableModel tabModel, String noPemeriksaan) {
        String query1 = "SELECT ID_Pasien, ID_Karyawan, Deskripsi FROM Pemeriksaan WHERE No_Pemeriksaan='"+noPemeriksaan+"'";
        String query2 = "SELECT detPem.No_Pemeriksaan, detPem.Kode_Tindakan, tdk.Nama_Tindakan, tdk.Biaya_Tindakan, "
                ...
                + "tindakan tdk ON detPem.Kode_Tindakan=tdk.Kode_Tindakan WHERE No_Pemeriksaan='"+noPemeriksaan+"'";
    ...
    public void addData(String noPemeriksaan, PemeriksaanSementara ps) {
